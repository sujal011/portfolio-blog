...
export const metadata = {
   ...
   alternates: {
      canonical: '/project/ai-powered-whiteboard',
   },
   openGraph: {
      url: "https://sujalbhavsar.in/project/ai-powered-whiteboard",
      images: [
         {
            url: '/ai-powered-whiteboard-project.png',
            width: 800,
            height: 600,
            alt: 'AI-Powered Whiteboard Project',
         },
      ],
   },
};
...
![AI-Powered Whiteboard Project](/ai-powered-whiteboard-project.png)
