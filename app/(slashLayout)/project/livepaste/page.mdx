export const metadata = {
   ...
   alternates: {
      canonical: '/project/livepaste',
   },
   openGraph: {
      url: "https://sujalbhavsar.in/project/livepaste",
      images: [
         {
            url: '/livepaste-project.png',
            width: 800,
            height: 600,
            alt: 'LivePaste Project',
         },
      ],
   },
};
...
![LivePaste Project](/livepaste-project.png)
